...
epsilon = 1                 # 1
eps_decay = 0.99999975      # avg 0.3 epsilon left after 300 episodes (0.99999975)
eps_min = 0.1
gamma = 0.90
double_q = False

max_memory = 100000         # steps
copy = 10000                # Target ntwork sync - 10000
learn_each = 3              # steps
save_each = 500000          # steps - (500000)
batch_size = 32             # steps
...
for e in range(episodes):
    ...
    frames_stats.append(agent.step - step)
    ...
    if e % show_every == 0 and e != 0:
        print('Episode {e} - '
              ...
              'Max X position {xm}'.format(e=e,
                                        ...
                                        fs=int(np.round((agent.step - step) / (time.time() - start_ep))),
